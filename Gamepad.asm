...
.equ HOCH_ID       = 0
.macro HOCH_TASTE 
@0 ausgaenge_reset2,HOCH_PORT_OUT,HOCH_PIN_OUT,HOCH_REG_OUT,HOCH_PORT_IN,HOCH_PORT2_IN,HOCH_PIN_IN,HOCH_REG_IN,HOCH_ID, @1, @2
.endm 
...
.equ RUNTER_ID       = 1
.macro RUNTER_TASTE 
@0 ausgaenge_reset2,RUNTER_PORT_OUT,RUNTER_PIN_OUT,RUNTER_REG_OUT,RUNTER_PORT_IN,RUNTER_PORT2_IN,RUNTER_PIN_IN,RUNTER_REG_IN,RUNTER_ID, @1, @2
.endm 
...
.equ LINKS_ID       = 2
.macro LINKS_TASTE 
@0 ausgaenge_reset2,LINKS_PORT_OUT,LINKS_PIN_OUT,LINKS_REG_OUT,LINKS_PORT_IN,LINKS_PORT2_IN,LINKS_PIN_IN,LINKS_REG_IN,LINKS_ID, @1, @2
.endm 
...
.equ RECHTS_ID       = 3
.macro RECHTS_TASTE 
@0 ausgaenge_reset2,RECHTS_PORT_OUT,RECHTS_PIN_OUT,RECHTS_REG_OUT,RECHTS_PORT_IN,RECHTS_PORT2_IN,RECHTS_PIN_IN,RECHTS_REG_IN,RECHTS_ID, @1, @2
.endm 
...
.equ EINS_ID       = 4
.macro EINS_TASTE 
@0 ausgaenge_reset,EINS_PORT_OUT,EINS_PIN_OUT,EINS_REG_OUT,EINS_PORT_IN,EINS_PORT2_IN,EINS_PIN_IN,EINS_REG_IN,EINS_ID, @1, @2
.endm 
...
.equ ZWEI_ID       = 5
.macro ZWEI_TASTE 
@0 ausgaenge_reset,ZWEI_PORT_OUT,ZWEI_PIN_OUT,ZWEI_REG_OUT,ZWEI_PORT_IN,ZWEI_PORT2_IN,ZWEI_PIN_IN,ZWEI_REG_IN,ZWEI_ID, @1, @2
.endm 
...
.equ DREI_ID       = 6
.macro DREI_TASTE 
@0 ausgaenge_reset,DREI_PORT_OUT,DREI_PIN_OUT,DREI_REG_OUT,DREI_PORT_IN,DREI_PORT2_IN,DREI_PIN_IN,DREI_REG_IN,DREI_ID, @1, @2
.endm 
...
.equ VIER_ID       = 7
.macro VIER_TASTE 
@0 ausgaenge_reset,VIER_PORT_OUT,VIER_PIN_OUT,VIER_REG_OUT,VIER_PORT_IN,VIER_PORT2_IN,VIER_PIN_IN,VIER_REG_IN,VIER_ID, @1, @2
.endm 
...
.equ SELECT_ID       = 8
.macro SELECT_TASTE 
@0 ausgaenge_reset,SELECT_PORT_OUT,SELECT_PIN_OUT,SELECT_REG_OUT,SELECT_PORT_IN,SELECT_PORT2_IN,SELECT_PIN_IN,SELECT_REG_IN,SELECT_ID, @1, @2
.endm 
...
.equ START_ID       = 9
.macro START_TASTE 
@0 ausgaenge_reset,START_PORT_OUT,START_PIN_OUT,START_REG_OUT,START_PORT_IN,START_PORT2_IN,START_PIN_IN,START_REG_IN,START_ID, @1, @2
.endm 
...
.equ ANALOG_ID       = 10
.macro ANALOG_TASTE 
@0 ausgaenge_reset,ANALOG_PORT_OUT,ANALOG_PIN_OUT,ANALOG_REG_OUT,ANALOG_PORT_IN,ANALOG_PORT2_IN,ANALOG_PIN_IN,ANALOG_REG_IN,ANALOG_ID, @1, @2
.endm 
...
.equ TURBO_ID       = 11
.macro TURBO_TASTE 
@0 ausgaenge_reset,TURBO_PORT_OUT,TURBO_PIN_OUT,TURBO_REG_OUT,TURBO_PORT_IN,TURBO_PORT2_IN,TURBO_PIN_IN,TURBO_REG_IN,TURBO_ID, @1, @2
.endm
...
.equ SUPER_ID       = 12
.macro SUPER_TASTE 
@0 ausgaenge_reset,SUPER_PORT_OUT,SUPER_PIN_OUT,SUPER_REG_OUT,SUPER_PORT_IN,SUPER_PORT2_IN,SUPER_PIN_IN,SUPER_REG_IN,SUPER_ID, @1, @2
.endm 
...
.equ R_EINS_ID       = 13
.macro R_EINS_TASTE 
@0 ausgaenge_reset,R_EINS_PORT_OUT,R_EINS_PIN_OUT,R_EINS_REG_OUT,R_EINS_PORT_IN,R_EINS_PORT2_IN,R_EINS_PIN_IN,R_EINS_REG_IN,R_EINS_ID, @1, @2
.endm 
...
.equ R_ZWEI_ID       = 14
.macro R_ZWEI_TASTE 
@0 ausgaenge_reset,R_ZWEI_PORT_OUT,R_ZWEI_PIN_OUT,R_ZWEI_REG_OUT,R_ZWEI_PORT_IN,R_ZWEI_PORT2_IN,R_ZWEI_PIN_IN,R_ZWEI_REG_IN,R_ZWEI_ID, @1, @2
.endm 
...
.equ L_EINS_ID       = 15
.macro L_EINS_TASTE 
@0 ausgaenge_reset,L_EINS_PORT_OUT,L_EINS_PIN_OUT,L_EINS_REG_OUT,L_EINS_PORT_IN,L_EINS_PORT2_IN,L_EINS_PIN_IN,L_EINS_REG_IN,L_EINS_ID, @1, @2
.endm 
...
.equ L_ZWEI_ID       = 16
.macro L_ZWEI_TASTE 
@0 ausgaenge_reset,L_ZWEI_PORT_OUT,L_ZWEI_PIN_OUT,L_ZWEI_REG_OUT,L_ZWEI_PORT_IN,L_ZWEI_PORT2_IN,L_ZWEI_PIN_IN,L_ZWEI_REG_IN,L_ZWEI_ID, @1, @2
.endm

HOCH_TASTE_TEXT:   .db "HOCH_TASTE",0,0
RUNTER_TASTE_TEXT: .db "RUNTER_TASTE",0,0
LINKS_TASTE_TEXT:  .db "LINKS_TASTE",0
RECHTS_TASTE_TEXT: .db "RECHTS_TASTE",0,0
EINS_TASTE_TEXT:   .db "EINS_TASTE",0,0
ZWEI_TASTE_TEXT:   .db "ZWEI_TASTE",0,0
DREI_TASTE_TEXT:   .db "DREI_TASTE",0,0
VIER_TASTE_TEXT:   .db "VIER_TASTE",0,0
L_EINS_TASTE_TEXT: .db "L_EINS_TASTE",0,0
L_ZWEI_TASTE_TEXT: .db "L_ZWEI_TASTE",0,0
R_EINS_TASTE_TEXT: .db "R_EINS_TASTE",0,0
R_ZWEI_TASTE_TEXT: .db "R_ZWEI_TASTE",0,0
START_TASTE_TEXT:  .db "START_TASTE",0
SUPER_TASTE_TEXT:  .db "SUPER_TASTE",0
ANALOG_TASTE_TEXT: .db "ANALOG_TASTE",0,0
TURBO_TASTE_TEXT:  .db "TURBO_TASTE",0
CLEAR_TASTE_TEXT:  .db "CLEAR_TASTE",0
SELECT_TASTE_TEXT: .db "SELECT_TASTE",0,0
