...
LICHT_TEXT:       .db "licht ",0,0 // licht 1 1       ---Licht Ein/Aus
...
MOTOR_TEXT:       .db "motor ",0,0 // motor 1 1       ---Motor Ein/Aus
MOTORG_TEXT:      .db "motorg ",0 // motorg 1 255    ---Motor Geschwindigkeit
SCHORNSTEIN_TEXT: .db "schornstein ",0,0 // schornstein 1   ---Schornstein Ein/Aus
L_TEXT:           .db "l ",0,0 // l 1 255255255   ---Licht RGB einstellen
SERVOC_TEXT:      .db "servoc ",0 // 
SERVO_TEXT:       .db "servo ",0,0 // servo 1 090 160 ---Geschuetz einstellen
MOTORR_TEXT:      .db "motorr ",0 // motorr 1 1      ---Motorrichtung
TEMPERATUR_TEXT:  .db "temperatur ",0 // temperatur 7    ---Temperatur messen
KONF_TEMP_TEXT:   .db "konf_temp ",0,0 // konf_temp 1     ---Temperaturmessung aktivieren/deaktivieren, nach start 200ms pause machen
...
ANTWORT_TEXT:     .db "antwort ",0,0 // antwort 1       ---Einstellen, ob nur Antworten mit Messwerten ?bertragen werden
